...
\def\pgfversion{2.10-cvs}
\def\pgftypesetversion{\oldstylenums{2}.\oldstylenums{10}--\textsc{cvs}}
...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/utilities/pgfrcs.code.tex,v 1.25 2010/11/07 11:28:08 cjorssen Exp $
