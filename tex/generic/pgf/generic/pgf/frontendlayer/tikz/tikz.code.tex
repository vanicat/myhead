...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/tikz.code.tex,v 1.81 2011/06/07 21:33:16 cjorssen Exp $
  ...
  \pgfutil@for\pgf@temp:=\pgf@list\do{%
	...
	\else
		\expandafter\ifx\csname tikz@library@\pgf@temp @loaded\endcsname\relax%
		  ...
		  \catcode`\@=11
		  \catcode`\|=12
		  \pgfutil@InputIfFileExists{tikzlibrary\pgf@temp.code.tex}{}{\pgfutil@InputIfFileExists{pgflibrary\pgf@temp.code.tex}{}{%
                      \PackageError{tikz}{I did not find the library
