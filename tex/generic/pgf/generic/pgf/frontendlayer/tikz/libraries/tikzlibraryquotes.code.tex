...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/tikzlibraryquotes.code.tex,v 1.1 2011/07/21 11:44:46 tantau Exp $

\def\tikz@quote@parser#1{\tikz@quote@@parser#1\pgf@stop}
\def\tikz@quote@@parser"#1"{\pgfutil@ifnextchar\bgroup{%
...
\tikzset{
  node quotes mean/.code={%
    \def\tikz@node@quotes@as##1##2{#1}
  },
  edge quotes mean/.code={%
    \def\tikz@edge@quotes@as##1##2{#1}
  },
