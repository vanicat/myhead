...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/datavisualization/tikzlibrarydatavisualization.code.tex,v 1.22 2010/02/24 23:09:00 tantau Exp $
...
\tikzset{
  ...
  fake value/.style={%
    /tikz/data visualization/before survey/.expanded={%
      ...
      \noexpand\tikz@dv@axis@mapper.fake in value({#1})%
    }%
  },
  %
