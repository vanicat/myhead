...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/datavisualization/tikzlibrarydatavisualization.code.tex,v 1.29 2010/09/02 12:20:41 tantau Exp $
...
\tikzset{
  ...
  % Strategies
  %
  basic strategy/.style={\tikz@dv@axis/@compute at positions={#1}},
  linear steps/.style={basic strategy=\tikz@lib@dv@compute@at@linear},
  %
  % Attribute setter
  %
...
\tikzset{
  /tikz/data visualization/axis options/.cd,
  exponential steps/.style={basic strategy=\tikz@lib@dv@compute@at@log},
  %
  % Basic setters
  %
  logarithmic/.style={
