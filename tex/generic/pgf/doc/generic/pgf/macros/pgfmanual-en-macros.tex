...
% $Header: /cvsroot/pgf/pgf/doc/generic/pgf/macros/pgfmanual-en-macros.tex,v 1.54 2011/05/11 17:22:36 tantau Exp $
...
\def\parameteritem@[#1]{\def\test{#1}\ifx\test\pgfutil@empty\else\hskip.7em#1:\fi}
...
\newenvironment{gdalgorithm}[1]{
  \begin{pgfmanualentry}
    ...
    \item{\small Usage: {\ttfamily/graph drawing/#1=}\meta{options}}\par
