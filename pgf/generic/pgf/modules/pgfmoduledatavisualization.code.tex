...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/modules/pgfmoduledatavisualization.code.tex,v 1.31 2010/02/24 23:09:00 tantau Exp $
...
\pgfooclass{scaling mapper}
{
  ...
  % 
  \method fake in value(#1) {
    \pgfoovalueof{range surveyor}.fake attribute value({#1})
  }
